                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="well with-header  with-footer">
                                <div class="header bg-blue">
                                    <a href="createNew" class="btn btn-purple shiny">创建新的杂志</a>
                                </div>
...
<c:forEach var="m" items="${list}" varStatus="index">
                                    <tr>
                                        <td>
                                            <c:out value="${m.id}" />
                                        </td>
                                        <td>
                                            <c:out value="${m.name}" escapeXml="false" />
                                        </td>
                                        <td>
                                            <c:out value="${m.path}" escapeXml="false" />
                                        </td>
                                        <td>
