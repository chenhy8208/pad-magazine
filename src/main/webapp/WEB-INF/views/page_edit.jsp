                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget  radius-bordered">
                            <div class="widget-header">
                                <span class="widget-caption">选择想要标注显示的页码</span>
                            </div>
                            <div class="widget-body">
                                <div class="docs-example">
                                    <form id="accountForm" method="post" class="form-horizontal bv-form" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
                                        <div class="tab-content tabs-flat">
                                            <div class="tab-pane active" id="address-tab">
                                                <div class="form-group has-feedback">
                                                    <div class="col-lg-8">
                                                        <select class="form-control" name="markIndex" id="markIndex" data-bv-field="country">
                                                            <option value="0">请选择</option>
<c:forEach var="s"  begin="1" end="${totalPage}">
                                                            <option value="${s}">第${s}页</option>
</c:forEach>
